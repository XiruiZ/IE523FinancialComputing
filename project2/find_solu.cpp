...
//#include "/Users/sreenivas/Documents/Courses/IE523/newmat11/newmatap.h"
//#include "/Users/sreenivas/Documents/Courses/IE523/newmat11/newmat.h"
//#include "/Users/sreenivas/Documents/Courses/IE523/newmat11/newmatio.h"
            ...
            for (int i = 0; i < solution.ncols(); i++)
            {
                ...
                if (did_i_pick_this[i]){
                    ...
                    for (int j=1; j<=solution.nrows(); j++){
                        tempcol.push_back(solution(j,i+1));
                    }
                    B.push_back(tempcol);
                }
            }
...
void process_data(char* argv[])
{
	...
	if (input_file.is_open()) // If the input file exists in the local directory
	{
		...
		cout << "Input file: " << file << " does not exist in present folder"  << endl;
	}	
}
